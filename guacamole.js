...
Guacamole.Client = function(tunnel) {
    ...
    this.setMouseScale = function (value) {
        scaleValue = value
    }

    this.getMouseScale = function () {
        return scaleValue
    }
    /**
    ...
    this.sendMouseState = function(mouseState) {
        ...
        // Send message
        tunnel.sendMessage("mouse", Math.floor(mouseState.x / scaleValue), Math.floor(mouseState.y / scaleValue), buttonMask);
    };
